...
def generate_data(
    ...
    #train_dl = DataLoader(oracle_dataset, batch_sampler=sampler, num_workers=num_workers)
    train_dl = DataLoader(oracle_dataset, batch_size=config['batch_size'], shuffle=True, drop_last=False, num_workers=config['num_workers'])
